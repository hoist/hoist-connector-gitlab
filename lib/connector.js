...
var apiBaseUri = 'https://gitlab.com/api/v3';
/**
   * A Hoist Connector for connecting to GitLab
   * @extends {OAuth2ConnectorBase}
   */

var GitLabConnector = function (_OAuth2ConnectorBase) {
  _inherits(GitLabConnector, _OAuth2ConnectorBase);
  ...
  function GitLabConnector(configuration) {
    _classCallCheck(this, GitLabConnector);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GitLabConnector).call(this, (0, _lodash.merge)({}, configuration, overrides)));
  ...
  _createClass(GitLabConnector, [{
    key: '_authorizeParams',
    value: function _authorizeParams(authorization) {
      return _get(Object.getPrototypeOf(GitLabConnector.prototype), '_authorizeParams', this).call(this, authorization).then(function (params) {
